;        STL     '8251 USART BIT DEFINITIONS.'
;        EJECT
	PAGE
...
USR     EQU     1               ; STATUS REGISTEP IS NEXT

SC.UART EQU     372Q            ; CONSOLE USAPT ADDPESS (IFF 8251)
...
UMI.1X  EQU     00000001B       ; CLOCK 8 1
UMI.16X EQU     00000010B       ; CLOCK X 16
UMI.64X EQU     00000011B       ; CLOCK 8 64
...
;      STATUS READ COMMANB BITS.

USR.BD  EQU     01000000B       ; Break Detect                    /80.08.gc/
USR.FE  EQU     00100000D       ; FRAMING ERROR
