...
0.1+2,3	Mar 2023  HRJ added symbol listing file

0.1+4	Jan 2025   HRJ added Chapman ifdef, ifndef
...
#define	SYMOPEN		"Symbol file did not open"
...
#define	LIST		14  /* HRJ */
#define	PRINT 		15  /* HRJ */
#define	IFDEF		16  /* Chapman */
#define	IFNDEF		17  /* Chapman */
